...
# 3. Aggiungiamo la radice al radar di Python per far funzionare l'import
...
def train_and_save_model(data_filename, model_filename, n_clusters=4):
    ...
    # --- PERCORSI AGGIORNATI ---
    # Ora ENTRAMBI i file (il CSV in lettura e il PKL in salvataggio) puntano a 'resources'
    data_path = os.path.join(cartella_principale, 'resources', data_filename)
