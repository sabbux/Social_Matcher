...
# Trova la cartella dove si trova app.py (es: .../xgboost/predictor)
current_dir = os.path.dirname(os.path.abspath(__file__))

# Sali di un livello per arrivare alla root del modello (es: .../xgboost)
xgboost_dir = os.path.dirname(current_dir)

# Punta alla cartella resources (es: .../xgboost/resources)
resource_dir = os.path.join(xgboost_dir, "resources")

# Assicurati che esista, ma senza sovrascriverla
